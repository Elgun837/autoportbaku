  ...
  return (
    <>
      <footer
        className="footer"
        style={{
          backgroundImage: bgLoaded ? "url('/footer_bg.webp')" : "none",
        }}
      >
          ...
          <div className="row">
            <div className="footer_content">
              <div className="logo_menu_wrapper ">
                ...
                <div className="trip_advisor_wrapper">
                  <div id="TA_cdswritereviewlg681" class="TA_cdswritereviewlg">
                    <ul id="9yjyHW" class="TA_links m1CPO0dAEC9q">
                      <li id="Twifhu3vpT" class="Uqewp9Xuf">
                        <a
                          target="_blank"
                          href="https://www.tripadvisor.com/Attraction_Review-g293934-d34043974-Reviews-AutoportBaku-Baku_Absheron_Region.html"
                        >
                          <img
                  ...
                  <script
                    async
                    src="https://www.jscache.com/wejs?wtype=cdswritereviewlg&amp;uniq=681&amp;locationId=34043974&amp;lang=en_US&amp;lang=en_US&amp;display_version=2"
                    data-loadtrk
                          ...
                          <>
                            <li>
                              <span className="footer_link">
                                Azure Business Center, 15 Nobel Avenue
                              </span>
                            </li>
                            <li>
                              <a
                                href="tel:(+994) 50 -481-00-81"
                                className="footer_link"
                              >
                                (+994) 50 -481-00-81
                              </a>
                            ...
                            <li>
                              <a
                                href="mailto:info@bakutransfers.com"
                                className="footer_link"
                              >
                                info@bakutransfers.com
                              </a>
                            </li>
                          </>
                        )}
