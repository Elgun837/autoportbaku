export const translations = {
  ...
  ru: {
    ...
    slide: {
      title: "Ваш персональный водитель",
    ...
    BookTrip: {
      desc: "Начните свое путешествие с Autoport Baku и ощутите первоклассный комфорт и сервис в каждой поездке.",
