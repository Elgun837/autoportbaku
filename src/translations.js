export const translations = {
  en: {
    ...
    formsLocation: {
      types: {
        ...
        maxPassengers: "Number of Passengers",
        luggage: "Number of Luggage",
        maxLuggage: "Pieces of Luggage",
        selectBtn: "Select This Vehicle",
        name: "Name",
        email: "Email",
        phone: "Phone",
  ...
  ru: {
    validation: {
      ...
      invalidDate: "Выберите правильную дату.",
      invalidTime: "Выберите правильное время.",
      invalidPassengers: "Укажите количество пассажиров.",
      invalidLuggage: "Укажите количество багажа.",
      selectServiceType: "Выберите тип услуги.",
      selectPickupLocation: "Выберите место отправления.",
      selectDropoffLocation: "Выберите место назначения.",
      ...
      invalidForm: "Пожалуйста, заполните все обязательные поля правильно.",
    },
    form: {
    ...
    formsLocation: {
      types: {
        ...
        maxPassengers: "Количество пассажиров:",
        luggage: "Количество багажа",
        maxLuggage: "Количество багажа",
        selectBtn: "Выбрать этот автомобиль",
        name: "Имя",
